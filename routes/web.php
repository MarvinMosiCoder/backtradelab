...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/market-backtest/account', [MarketBacktestController::class, 'show'])->middleware('throttle:backtest-read')->name('market-backtest.show');
    ...
    Route::post('/market-backtest/reset', [MarketBacktestController::class, 'reset'])->middleware('throttle:backtest-heavy')->name('market-backtest.reset');
    Route::post('/market-backtest/sessions', [MarketBacktestController::class, 'startSession'])->middleware('throttle:backtest-write')->name('market-backtest.sessions.start');
    Route::post('/market-backtest/sessions/{session}/end', [MarketBacktestController::class, 'endSession'])->middleware('throttle:backtest-write')->name('market-backtest.sessions.end');
    Route::post('/market-backtest/positions', [MarketBacktestController::class, 'openPosition'])->middleware('throttle:backtest-write')->name('market-backtest.positions.open');
    Route::put('/market-backtest/positions/{position}/risk', [MarketBacktestController::class, 'updatePositionRisk'])->middleware('throttle:backtest-write')->name('market-backtest.positions.risk');
    Route::post('/market-backtest/positions/{position}/trigger', [MarketBacktestController::class, 'triggerPosition'])->middleware('throttle:backtest-write')->name('market-backtest.positions.trigger');
    Route::post('/market-backtest/positions/{position}/cancel', [MarketBacktestController::class, 'cancelPosition'])->middleware('throttle:backtest-write')->name('market-backtest.positions.cancel');
    Route::post('/market-backtest/positions/{position}/close', [MarketBacktestController::class, 'closePosition'])->middleware('throttle:backtest-write')->name('market-backtest.positions.close');
    Route::post('/market-backtest/positions/{position}/snapshot', [MarketBacktestController::class, 'uploadPositionSnapshot'])->middleware('throttle:backtest-heavy')->name('market-backtest.positions.snapshot');
