...
import { CalendarClock, Check, Clock3, CreditCard, FileImage, ShieldCheck, X } from 'lucide-react';
...
export default function UserIndex({ subscription }) {
  ...
  return <><Head title="Subscription"/>{showPlans&&<SubscriptionModal onClose={()=>setShowPlans(false)}/>}<div className="mx-auto max-w-5xl space-y-5">
