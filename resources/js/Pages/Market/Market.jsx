            ...
            <section className={`overflow-hidden rounded-2xl border ${panel}`}>
                <div className={`grid gap-4 p-4 sm:p-5 lg:grid-cols-[1fr_auto] lg:items-center ${dark ? 'bg-gradient-to-r from-[#172554] via-[#131722] to-[#0b0e14]' : 'bg-gradient-to-r from-blue-50 via-white to-slate-50'}`}>
                    ...
                    <div className="grid grid-cols-2 gap-2 sm:grid-cols-4 lg:flex">
                        <QuickAction href="/dashboard" icon={CandlestickChart} label="Workspace" dark={dark}/><QuickAction href="/trade-report" icon={FileChartColumn} label="Trade Report" dark={dark}/><QuickAction href="/subscription" icon={CreditCard} label="Subscription" dark={dark}/><QuickAction href="/help" icon={BookOpen} label="Help" dark={dark}/>
                    </div>
                </div>
            </section>
