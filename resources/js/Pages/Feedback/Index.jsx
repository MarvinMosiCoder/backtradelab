...
import { Bug, CheckCircle2, CreditCard, Gauge, Lightbulb, MessageCircle, MessageSquarePlus, Send, Sparkles, UserRound, WandSparkles } from 'lucide-react';
...
export default function FeedbackIndex() {
    ...
    const [form, setForm] = useState({ category: 'payment', title: '', description: '' });
    ...
    return <><Head title="Customer Support" /><div className={`mx-auto max-w-6xl space-y-4 py-2 ${isDark ? 'text-[#d1d4dc]' : 'text-slate-900'}`}>
        ...
        <div className="grid gap-4 lg:grid-cols-[1.05fr_.95fr]">
            <form onSubmit={submit} className={`rounded-xl border p-5 ${panel}`}>
                <h2 className={`text-sm font-bold ${isDark ? 'text-white' : 'text-slate-900'}`}>How can we help?</h2>
