...
import { AlertTriangle, Bell, LayoutDashboard, LogOut, Menu, MessageSquareText, Moon, Settings, ShieldCheck, Sun, Users, X } from 'lucide-react';
...
export default function AdminNavbar() {
    ...
    return <header className={`flex h-14 items-center border-b px-3 sm:px-4 ${isDark ? 'border-[#2a2e39] bg-[#131722] text-[#d1d4dc]' : 'border-slate-200 bg-white text-slate-800'}`}>
        ...
        <nav className="hidden items-center gap-1 lg:flex"><Link href="/dashboard" className={navLink}><LayoutDashboard size={14}/>Overview</Link><Link href="/users" className={navLink}><Users size={14}/>Users</Link><Link href="/admin/feedback" className={navLink}><MessageSquareText size={14}/>Feedback</Link><Link href="/settings" className={navLink}><Settings size={14}/>Settings</Link></nav>
